...
window.taskManagerQuickTask.comment = {};

window.taskManagerQuickTask.comment.init = function() {
	window.taskManagerQuickTask.comment.event();
};

window.taskManagerQuickTask.comment.event = function() {};

window.taskManagerQuickTask.comment.delete_success = function( element, response ) {
	jQuery( element ).closest( 'li' ).fadeOut();
};

window.taskManagerQuickTask.comment.saved_comment_success = function( element, response ) {
...
window.taskManagerQuickTask.correctiveTask = {};

window.taskManagerQuickTask.correctiveTask.init = function() {};
 ...
 * @version 6.2.5.0
 */
window.taskManagerQuickTask.correctiveTask.openedTaskPopup = function( triggeredElement, response ) {
	jQuery( '.popup.corrective-task .content' ).html( response.data.view );
	jQuery( '.popup.corrective-task.loading' ).removeClass( 'loading' );
};

window.taskManagerQuickTask.danger = {};

window.taskManagerQuickTask.danger.init = function() {
	window.taskManagerQuickTask.danger.event();
};

window.taskManagerQuickTask.danger.event = function() {
	jQuery( document ).on( 'click', '.table.risk .categorie-container.danger .item', window.taskManagerQuickTask.danger.selectDanger );
};
 ...
 * @version 6.2.4.0
 */
window.taskManagerQuickTask.danger.selectDanger = function( event ) {
	var element = jQuery( this );
...
window.taskManagerQuickTask.document = {};

window.taskManagerQuickTask.document.init = function() {
	window.taskManagerQuickTask.document.event();
};

window.taskManagerQuickTask.document.event = function() {
	jQuery( ".wp-digi-societytree-right-container" ).on( "click", "#wpdigi-save-element-sheet", window.taskManagerQuickTask.document.save_element_sheet );
	jQuery( ".wp-digi-societytree-right-container" ).on( "click", ".wp-digi-list-document .wp-digi-action-regenerate", window.taskManagerQuickTask.document.regenerate_document );
	jQuery( document ).on( 'click', '.wp-digi-doc-pagination a', window.taskManagerQuickTask.document.pagination );

};

window.taskManagerQuickTask.document.save_element_sheet = function ( event ) {
	event.preventDefault();
...
window.taskManagerQuickTask.document.regenerate_document = function ( event ) {
	event.preventDefault();
...
window.taskManagerQuickTask.document.pagination = function( event ) {
	event.preventDefault();
...
window.taskManagerQuickTask.DUER = {};

window.taskManagerQuickTask.DUER.init = function() {
	window.taskManagerQuickTask.DUER.event();
};

window.taskManagerQuickTask.DUER.event = function() {};
 ...
 * @version 6.2.4.0
 */
window.taskManagerQuickTask.DUER.fill_textarea_in_popup = function( triggeredElement, popupElement, event, args ) {
	var textareaContent = '';
 ...
 * @version 6.2.4.0
 */
window.taskManagerQuickTask.DUER.view_in_popup = function( triggeredElement, popupElement, event, args ) {
	if ( args ) {
		popupElement.find( 'h2' ).text( args.title );
...
window.taskManagerQuickTask.DUER.set_textarea_content = function( triggeredElement, event, args ) {
	if ( args && args['target'] ) {
...
window.taskManagerQuickTask.DUER.popup_for_generate_DUER = function( triggeredElement, popupElement, event, args ) {
	var data = {
	...
	window.taskManagerQuickTask.request.send( popupElement, data );
};

window.taskManagerQuickTask.DUER.displayedSocietyDUERSuccess = function( popup, response ) {
	popup.find( '.change-content' ).html( response.data.view );

	window.taskManagerQuickTask.DUER.generateDUER( jQuery( '.open-popup.add' ), { index: 0 } );
};

window.taskManagerQuickTask.DUER.generateDUER = function( triggeredElement, preData ) {
	var data = {};
	var i = 0;
	...
	window.taskManagerQuickTask.request.send( triggeredElement, data );
};
 ...
 * @version 6.2.4.0
 */
window.taskManagerQuickTask.DUER.generatedDUERSuccess = function( element, response ) {
	...
	if ( ! response.data.end ) {
		window.taskManagerQuickTask.DUER.generateDUER( element, response.data );
	} else {
		jQuery( '.popup' ).removeClass( 'no-close' );
	}
};

window.taskManagerQuickTask.DUER.callback_generate_duer_error = function() {};

window.taskManagerQuickTask.DUER.close_popup_generate_DUER = function( element, event ) {
	jQuery( '.digirisk-wrap .button[data-action="digi_list_duer"]' ).click();
};

"use strict";

window.taskManagerQuickTask.epi = {};

window.taskManagerQuickTask.epi.init = function() {
	window.taskManagerQuickTask.epi.event();
};

window.taskManagerQuickTask.epi.event = function() {};

window.taskManagerQuickTask.epi.save_epi_success = function( element, response ) {
  jQuery( '.wp-digi-epi' ).replaceWith( response.data.template );
}

window.taskManagerQuickTask.epi.load_epi_success = function( element, response ) {
  jQuery( element ).closest( 'li' ).replaceWith( response.data.template );
}

window.taskManagerQuickTask.epi.delete_epi_success = function( element, response ) {
  jQuery( element ).closest( 'li' ).fadeOut();
}

window.taskManagerQuickTask.evaluation_method_digirisk = {};

window.taskManagerQuickTask.evaluation_method_digirisk.init = function() {
	window.taskManagerQuickTask.evaluation_method_digirisk.event();
};

window.taskManagerQuickTask.evaluation_method_digirisk.event = function() {
	jQuery( document ).on( 'click', '.table.risk .cotation-container li.item:not(.open-popup)', window.taskManagerQuickTask.evaluation_method_digirisk.select_cotation );
};

window.taskManagerQuickTask.evaluation_method_digirisk.select_cotation = function( event ) {
	var element = jQuery( this );
 ...
 * @version 6.2.4.0
 */
window.taskManagerQuickTask.evaluationMethodEvarisk = {};

window.taskManagerQuickTask.evaluationMethodEvarisk.init = function() {
	window.taskManagerQuickTask.evaluationMethodEvarisk.event();
};

window.taskManagerQuickTask.evaluationMethodEvarisk.event = function() {
	jQuery( document ).on( 'click', '.popup.popup-evaluation.active tr td', window.taskManagerQuickTask.evaluationMethodEvarisk.select_variable );
	jQuery( document ).on( 'click', '.popup.popup-evaluation.active .button.green', window.taskManagerQuickTask.evaluationMethodEvarisk.close_modal );
};

window.taskManagerQuickTask.evaluationMethodEvarisk.select_variable = function( event ) {
	var element = jQuery( this );
...
window.taskManagerQuickTask.evaluationMethodEvarisk.close_modal = function( event ) {
	var element = jQuery( this );
...
window.taskManagerQuickTask.evaluator = {};

window.taskManagerQuickTask.evaluator.init = function() {
	window.taskManagerQuickTask.evaluator.event();
};

window.taskManagerQuickTask.evaluator.event = function() {
	jQuery( document ).on( 'click', '.digirisk-wrap table.evaluators input[type="checkbox"]', window.taskManagerQuickTask.evaluator.setTime );
	jQuery( document ).on( 'click', '.wp-form-evaluator-to-assign .wp-digi-pagination a', window.taskManagerQuickTask.evaluator.pagination );
};
 ...
 * @version 6.2.4.0
 */
window.taskManagerQuickTask.evaluator.setTime = function( event ) {
	var element = jQuery( this );
 ...
 * @version 6.2.4.0
 */
window.taskManagerQuickTask.evaluator.callback_edit_evaluator_assign_success = function( triggeredElement, response ) {
 ...
 * @version 6.2.4.0
 */
window.taskManagerQuickTask.evaluator.callback_detach_evaluator_success = function( triggeredElement, response ) {
	jQuery( 'table.affected-evaluator' ).replaceWith( response.data.template );
};
 ...
 * @version 6.2.4.0
 */
window.taskManagerQuickTask.evaluator.pagination = function( event ) {
	var href = jQuery( this ).attr( 'href' ).split( '&' );
 ...
 * @type {Object}
 */
window.taskManagerQuickTask.export = {};
 ...
 * @return {void}
 */
window.taskManagerQuickTask.export.init = function() {
	window.taskManagerQuickTask.export.event();
};
 ...
 * @return {void}
 */
window.taskManagerQuickTask.export.event = function() {
	jQuery( document ).on( 'submit', '#digi-data-export #digi-export-form', window.taskManagerQuickTask.export.create_export );
	jQuery( document ).on( 'change', '#digi-data-export #digi-import-form input[type="file"]', window.taskManagerQuickTask.export.make_import );
};
 ...
 * @return {void}
 */
window.taskManagerQuickTask.export.create_export = function( event ) {
	...
	jQuery( this ).closest( 'form' ).ajaxSubmit( {
		...
		success: function( response ) {
			...
			window.taskManagerQuickTask.global.downloadFile( response.data.url_to_file, response.data.filename );
		}
	} );
},
 ...
 * @return {void}
 */
window.taskManagerQuickTask.export.make_import = function( event ) {
	...
	window.taskManagerQuickTask.export.request_import( data );
},
 ...
 * @return {void}
 */
window.taskManagerQuickTask.export.request_import = function( data ) {
	jQuery.ajax( {
		url: ajaxurl,
		data: data,
		processData: false,
...
window.taskManagerQuickTask.gallery = {};

window.taskManagerQuickTask.gallery.init = function() {
	window.taskManagerQuickTask.gallery.event();
};

window.taskManagerQuickTask.gallery.event = function() {
	jQuery( document ).on( 'keyup', window.taskManagerQuickTask.gallery.keyup );
	jQuery( document ).on( 'click', '.gallery', function( event ) { event.preventDefault(); return false; } );
	jQuery( document ).on( 'click', '.gallery .prev', window.taskManagerQuickTask.gallery.prev );
	jQuery( document ).on( 'click', '.gallery .next', window.taskManagerQuickTask.gallery.next );
	jQuery( document ).on( 'click', '.gallery .set-as-thumbnail', window.taskManagerQuickTask.gallery.set_thumbnail );
	jQuery( document ).on( 'click', '.gallery .close', window.taskManagerQuickTask.gallery.close );
};

window.taskManagerQuickTask.gallery.keyup = function( event ) {
	if ( event.keyCode == 37 ) {
...
window.taskManagerQuickTask.gallery.open = function( element ) {
	element.find( '.gallery' ).show();
};

window.taskManagerQuickTask.gallery.prev = function( event ) {
	event.preventDefault();
...
window.taskManagerQuickTask.gallery.next = function( event ) {
	event.preventDefault();
...
window.taskManagerQuickTask.gallery.set_thumbnail = function( event ) {
	var data = {
...
window.taskManagerQuickTask.gallery.close = function( event ) {
	jQuery( '.gallery' ).hide();
};

window.taskManagerQuickTask.gallery.dessociate_file_success = function( element, response ) {
 ...
 * @version 6.2.5.0
 */
window.taskManagerQuickTask.media = {
 ...
 * @version 6.2.5.0
 */
window.taskManagerQuickTask.media.init = function() {
  window.taskManagerQuickTask.media.event();
};

window.taskManagerQuickTask.media.event = function() {
  jQuery( document ).on( 'click', '.media', window.taskManagerQuickTask.media.open_popup );
};

window.taskManagerQuickTask.media.open_popup = function( event ) {
	var element = jQuery( this );

  event.preventDefault();

  window.taskManagerQuickTask.media.element_id = element.data( 'id' );
  window.taskManagerQuickTask.media._wpnonce = element.data( 'nonce' );
  window.taskManagerQuickTask.media.title = element.data( 'title' );
  window.taskManagerQuickTask.media.object_name = element.data( 'object-name' );
  window.taskManagerQuickTask.media.type = element.data( 'type' );
  window.taskManagerQuickTask.media.action = element.data( 'action' );
  window.taskManagerQuickTask.media.have_thumbnail = element.hasClass( 'wp-digi-element-thumbnail' ) ? true : false;
  window.wp.media.model.settings.post.id = element.data( 'id' );

  if( element.find( '.gallery' ).length === 0 ) {
    window.taskManagerQuickTask.media.load_media_upload( element, element.data( 'id' )  );
  }
  else {
    window.taskManagerQuickTask.gallery.open( element );
  }
};

window.taskManagerQuickTask.media.load_media_upload = function( element, post_id ) {
  if ( !window.taskManagerQuickTask.media.file_frame ) {
    window.taskManagerQuickTask.media.file_frame = new window.wp.media.view.MediaFrame.Post( {
    ...
    window.taskManagerQuickTask.media.file_frame.el.className += ' digi-upload-' + post_id;
    window.taskManagerQuickTask.media.file_frame.on( "insert", function() { window.taskManagerQuickTask.media.selected_file( element ); } );
  }

  window.taskManagerQuickTask.media.open_media_upload();
};

window.taskManagerQuickTask.media.open_media_upload = function() {
  window.taskManagerQuickTask.media.file_frame.open();
  return;
};

window.taskManagerQuickTask.media.selected_file = function( element ) {
  var selected_file = window.taskManagerQuickTask.media.file_frame.state().get( 'selection' );
  var selected_JSON;
  ...
  if ( window.taskManagerQuickTask.media.element_id === 0 && window.taskManagerQuickTask.media.action != 'eo_set_model' ) {
    window.taskManagerQuickTask.media.display_attachment( selected_JSON, element );
  }
  else {
    window.taskManagerQuickTask.media.associate_file( selected_file_id );
  }
};

window.taskManagerQuickTask.media.display_attachment = function( selected_JSON, element ) {
...
window.taskManagerQuickTask.media.associate_file = function( selectedFileId ) {
	if ( 'eo_set_model' === window.taskManagerQuickTask.media.action ) {
		jQuery( '.upload[data-type="' + window.taskManagerQuickTask.media.type + '"]' ).addClass( 'loading' );
	} else {
		jQuery( 'span.media[data-id="' + window.taskManagerQuickTask.media.element_id + '"]' ).addClass( 'loading' );
	}

  var data = {
    action: window.taskManagerQuickTask.media.action,
    file_id: selectedFileId,
    _wpnonce: window.taskManagerQuickTask.media._wpnonce,
    title: window.taskManagerQuickTask.media.title,
    type: window.taskManagerQuickTask.media.type,
    element_id: window.taskManagerQuickTask.media.element_id,
    object_name: window.taskManagerQuickTask.media.object_name,
    thumbnail: window.taskManagerQuickTask.media.have_thumbnail,
  };
  ...
  jQuery.post( window.ajaxurl, data, function( response ) {
    if ( response.data.type == 'set_model' ) {
      ...
      jQuery( 'span.media[data-id="'+ window.taskManagerQuickTask.media.element_id + '"]' ).replaceWith( response.data.template );
    }
  });
};
...
window.taskManagerQuickTask.group = {};
 ...
 * @version 6.2.4.0
 */
window.taskManagerQuickTask.group.init = function() {};
 ...
 * @version 6.2.4.0
 */
window.taskManagerQuickTask.group.createdGroupSuccess = function( element, response ) {
...
window.taskManagerQuickTask.handle_model = {};

window.taskManagerQuickTask.handle_model.init = function() {
	window.taskManagerQuickTask.handle_model.event();
};
 ...
 * @return {void}
 */
window.taskManagerQuickTask.handle_model.event = function() {};
 ...
 * @return {void}
 */
window.taskManagerQuickTask.handle_model.popup_historic_loaded = function( element, response ) {
 ...
 * @param {void}
 */
window.taskManagerQuickTask.handle_model.reset_default_model_success = function( element, response ) {
...
window.taskManagerQuickTask.installer = {};

window.taskManagerQuickTask.installer.init = function() {
	window.taskManagerQuickTask.installer.event();
};

window.taskManagerQuickTask.installer.event = function() {
	jQuery( document ).on( 'keyup', '.wpdigi-installer input[name="groupment[title]"]', window.taskManagerQuickTask.installer.key_up_groupment_title );
	jQuery( document ).on( 'keyup', '.wpdigi-installer input.input-domain-mail, .user-dashboard input.input-domain-mail', window.taskManagerQuickTask.installer.key_up_domain_mail );
};

window.taskManagerQuickTask.installer.key_up_groupment_title = function( event ) {
	if ( 13 === event.keyCode ) {
		jQuery( '.submit-form' ).click();
	}
};

window.taskManagerQuickTask.installer.key_up_domain_mail = function( event ) {
	if ( 13 === event.keyCode ) {
 ...
 * @version 6.2.4.0
 */
window.taskManagerQuickTask.installer.savedSociety = function( element, response ) {
	...
	window.taskManagerQuickTask.installer.requestInstallComponent();
};
 ...
 * @return {void}
 */
window.taskManagerQuickTask.installer.requestInstallComponent = function() {
	var _wpnonce = jQuery( '.wpdigi-installer .wpdigi-components .nonce-installer-components' ).val();
	window.taskManagerQuickTask.request.get( ajaxurl + '?action=installer_components&_wpnonce=' + _wpnonce );
};
 ...
 * @version 6.2.4.0
 */
window.taskManagerQuickTask.installer.installedComponentSuccess = function( response ) {
...
window.taskManagerQuickTask.legalDisplay = {};

window.taskManagerQuickTask.legalDisplay.init = function() {};
 ...
 * @version 6.2.4.0
 */
window.taskManagerQuickTask.legalDisplay.generatedSuccess = function() {
...
window.taskManagerQuickTask.navigation = {};
 ...
 * @version 6.2.4.0
 */
window.taskManagerQuickTask.navigation.init = function() {
	window.taskManagerQuickTask.navigation.event();
};
 ...
 * @version 6.2.4.0
 */
window.taskManagerQuickTask.navigation.event = function() {
	jQuery( document ).on( 'click', '.digirisk-wrap .navigation-container .content li span.action-attribute', window.taskManagerQuickTask.navigation.setItemActiveInToggle );
	jQuery( document ).on( 'click', '.digirisk-wrap .navigation-container .workunit-list li span.action-attribute', window.taskManagerQuickTask.navigation.setItemActiveInWorkunitList );
};
 ...
 * @version 6.2.4.0
 */
window.taskManagerQuickTask.navigation.setItemActiveInToggle = function( event ) {
...
window.taskManagerQuickTask.recommendation = {};

window.taskManagerQuickTask.recommendation.init = function() {
	window.taskManagerQuickTask.recommendation.event();
};

window.taskManagerQuickTask.recommendation.event = function() {
	jQuery( document ).on( 'click', '.table.recommendation .categorie-container.recommendation .item', window.taskManagerQuickTask.recommendation.selectRecommendation );
};
 ...
 * @version 6.2.4.0
 */
window.taskManagerQuickTask.recommendation.selectRecommendation = function( event ) {
	var element = jQuery( this );
	element.closest( '.content' ).removeClass( 'active' );
 ...
 * @version 6.2.4.0
 */
window.taskManagerQuickTask.recommendation.beforeSaveRecommendation = function( triggeredElement ) {
 ...
 * @version 6.2.4.0
 */
window.taskManagerQuickTask.recommendation.savedRecommendationSuccess = function( element, response ) {
	jQuery( 'table.recommendation' ).replaceWith( response.data.template );
	window.taskManagerQuickTask.date.init();
};
 ...
 * @version 6.2.4.0
 */
window.taskManagerQuickTask.recommendation.loadedRecommendationSuccess = function( element, response ) {
 ...
 * @version 6.2.4.0
 */
window.taskManagerQuickTask.recommendation.deletedRecommendationSuccess = function( element, response ) {
...
window.taskManagerQuickTask.risk_page = {};

window.taskManagerQuickTask.risk_page.init = function() {
	window.taskManagerQuickTask.risk_page.event();
};

window.taskManagerQuickTask.risk_page.event = function() {
	jQuery( document ).on( 'click', '.risk-page .button.green', window.taskManagerQuickTask.risk_page.send_all_risk );
	jQuery( document ).on( 'click', '.risk-page table tr input:not(input[type="checkbox"]), tr .toggle, tr textarea, tr .popup', window.taskManagerQuickTask.risk_page.checkTheCheckbox );
};

window.taskManagerQuickTask.risk_page.send_all_risk = function( event ) {
	if ( event ) {
		event.preventDefault();
	}
 ...
 * @version 6.2.4.0
 */
window.taskManagerQuickTask.risk_page.checkTheCheckbox = function( event ) {
	jQuery( this ).closest( 'tr' ).find( 'input[type="checkbox"]' ).prop( 'checked', true );
	jQuery( this ).closest( 'tr' ).find( '.edit-risk' ).addClass( 'checked' );
};

window.taskManagerQuickTask.risk_page.savedRiskSuccess = function( element, response ) {
	jQuery( element ).closest( 'tr' ).replaceWith( response.data.template );
	window.taskManagerQuickTask.risk_page.send_all_risk( undefined );
};
 ...
 * @version 6.2.4.0
 */
window.taskManagerQuickTask.risk = {};

window.taskManagerQuickTask.risk.init = function() {};

window.taskManagerQuickTask.risk.deletedRiskSuccess = function( element, response ) {
	element.closest( 'tr' ).fadeOut();
};

window.taskManagerQuickTask.risk.loadedRiskSuccess = function( element, response ) {
  element.closest( 'tr' ).replaceWith( response.data.template );
	window.taskManagerQuickTask.date.init();
};

window.taskManagerQuickTask.risk.beforeSaveRisk = function( triggeredElement ) {
 ...
 * @version 6.2.4.0
 */
window.taskManagerQuickTask.risk.savedRiskSuccess = function( triggeredElement, response ) {
	triggeredElement.closest( 'table.risk' ).replaceWith( response.data.template );
	window.taskManagerQuickTask.date.init();
};

window.taskManagerQuickTask.search = {};

window.taskManagerQuickTask.search.init = function() {
	window.taskManagerQuickTask.search.event();
};

window.taskManagerQuickTask.search.tabChanged = function() {
	window.taskManagerQuickTask.search.event();
};

window.taskManagerQuickTask.search.renderChanged = function() {
	window.taskManagerQuickTask.search.event();
};
 ...
 * @version 6.2.4.0
 */
window.taskManagerQuickTask.search.event = function() {
...
window.taskManagerQuickTask.sheet_groupment = {};

window.taskManagerQuickTask.sheet_groupment.init = function() {};
 ...
 * @version 6.2.4.0
 */
window.taskManagerQuickTask.sheet_groupment.generatedSheetGroupment = function( triggeredElement, response ) {
...
window.taskManagerQuickTask.sheet_workunit = {};

window.taskManagerQuickTask.sheet_workunit.init = function() {};
 ...
 * @version 6.2.4.0
 */
window.taskManagerQuickTask.sheet_workunit.generatedFicheDePosteSuccess = function() {
...
window.taskManagerQuickTask.society = {};

window.taskManagerQuickTask.society.init = function() {
	window.taskManagerQuickTask.society.event();
};

window.taskManagerQuickTask.society.event = function() {
	jQuery( document ).on( 'keyup', 'input[name="title"]', window.taskManagerQuickTask.society.keyUpSaveIdentity );
};
 ...
 * @version 6.2.4.0
 */
window.taskManagerQuickTask.society.loadedSocietySuccess = function( element, response ) {
	jQuery( '.digirisk-wrap' ).replaceWith( response.data.template );
};
 ...
 * @version 6.2.5.0
 */
window.taskManagerQuickTask.society.keyUpSaveIdentity = function( event ) {
 ...
 * @version 6.2.4.0
 */
window.taskManagerQuickTask.society.savedSocietySuccess = function( element, response ) {
	jQuery( '.digirisk-wrap' ).replaceWith( response.data.template );
};
 ...
 * @version 6.2.4.0
 */
window.taskManagerQuickTask.society.deletedSocietySuccess = function( triggeredElement, response ) {
	jQuery( '.digirisk-wrap' ).replaceWith( response.data.template );
};
 ...
 * @version 6.2.4.0
 */
window.taskManagerQuickTask.society.savedSocietyConfiguration = function( triggeredElement, response ) {
...
window.taskManagerQuickTask.tools = {};

window.taskManagerQuickTask.tools.init = function() {
	window.taskManagerQuickTask.tools.event();
};

window.taskManagerQuickTask.tools.event = function() {
	jQuery( document ).on( 'click', '.digi-tools-main-container .nav-tab', window.taskManagerQuickTask.tools.tab_switcher );
	jQuery( document ).on( 'click', '.reset-method-evaluation', window.taskManagerQuickTask.tools.reset_evaluation_method );
	jQuery( document ).on( 'click', '.element-risk-compilation', window.taskManagerQuickTask.tools.risk_fixer );
	jQuery( document ).on( 'click', '.fix-recommendation', window.taskManagerQuickTask.tools.recommendation_fixer );
	jQuery( document ).on( 'click', '.fix-doc', window.taskManagerQuickTask.tools.doc_fixer );
};

window.taskManagerQuickTask.tools.tab_switcher = function( event ) {
  event.preventDefault();
...
window.taskManagerQuickTask.tools.reset_evaluation_method = function( event ) {
  event.preventDefault();
  ...
  if ( window.confirm( window.digi_tools_confirm ) ) {
    ...
    var data = {
      ...
      _wpnonce: jQuery( this ).data( 'nonce' )
		...
		window.taskManagerQuickTask.tools.exec_request( li, data, this );
  }
},

window.taskManagerQuickTask.tools.risk_fixer = function( event ) {
  event.preventDefault();
...
window.taskManagerQuickTask.tools.recommendation_fixer = function( event ) {
  event.preventDefault();
...
window.taskManagerQuickTask.tools.doc_fixer = function( event ) {
  event.preventDefault();
...
window.taskManagerQuickTask.tools.exec_request = function( li, data, element ) {
	jQuery.post( window.ajaxurl, data, function() {
...
window.taskManagerQuickTask.user = {};

window.taskManagerQuickTask.user.init = function() {
	window.taskManagerQuickTask.user.event();
};
 ...
 * @version 6.2.4.0
 */
window.taskManagerQuickTask.user.event = function() {
	jQuery( document ).on( 'click', '.wp-form-user-to-assign .wp-digi-pagination a', window.taskManagerQuickTask.user.pagination );
};
 ...
 * @version 6.2.4.0
 */
window.taskManagerQuickTask.user.editUserAssignSuccess = function( triggeredElement, response ) {
	window.taskManagerQuickTask.user.render( response );
};
 ...
 * @version 6.2.4.0
 */
window.taskManagerQuickTask.user.detachUserSuccess = function( triggeredElement, response ) {
	window.taskManagerQuickTask.user.render( response );
};
 ...
 * @version 6.2.4.0
 */
window.taskManagerQuickTask.user.render = function( response ) {
	jQuery( 'section.users' ).replaceWith( response.data.template );
	window.taskManagerQuickTask.render.call_render_changed();
};

window.taskManagerQuickTask.user.pagination = function( event ) {
	event.preventDefault();
...
window.taskManagerQuickTask.userDashboard = {};

window.taskManagerQuickTask.userDashboard.init = function() {
	window.taskManagerQuickTask.userDashboard.event();
};

window.taskManagerQuickTask.userDashboard.event = function() {
	jQuery( document ).on( 'keyup', '.user-dashboard .input-domain-mail', window.taskManagerQuickTask.userDashboard.keyupUpdateEmail );
	jQuery( document ).on( 'keyup', '.user-dashboard table.users tr:last input.lastname', window.taskManagerQuickTask.userDashboard.keyupUpdateEmail );
	jQuery( document ).on( 'keyup', '.user-dashboard table.users tr:last input.firstname', window.taskManagerQuickTask.userDashboard.keyupUpdateEmail );
	jQuery( document ).on( 'keyup', '.user-dashboard table.users tr:last input.email', window.taskManagerQuickTask.userDashboard.keyEnterSendForm );
	jQuery( document ).on( 'click', '.user-dashboard .wp-digi-action-save-domain-mail', window.taskManagerQuickTask.userDashboard.save_domain_mail );
};
 ...
 * @version 6.2.5.0
 */
window.taskManagerQuickTask.userDashboard.save_domain_mail = function( event ) {
	var element = jQuery( this );
	var data = {};
 ...
 * @version 6.2.5.0
 */
window.taskManagerQuickTask.userDashboard.keyupUpdateEmail = function( event ) {
	...
	var together = window.taskManagerQuickTask.global.removeDiacritics( firstname + '.' + lastname + '@' + domainMail ).toLowerCase();
	...
	if ( 'input-domain-mail' !== event.target.className ) {
		window.taskManagerQuickTask.userDashboard.keyEnterSendForm( event, jQuery( this ) );
	}
};
 ...
 * @version 6.2.4.0
 */
window.taskManagerQuickTask.userDashboard.keyEnterSendForm = function( event ) {
	if ( 13 === event.keyCode ) {
 ...
 * @version 6.2.5.0
 */
window.taskManagerQuickTask.userDashboard.deletedUserSuccess = function( element, response ) {
  element.closest( 'tr' ).fadeOut();
};
 ...
 * @version 6.2.5.0
 */
window.taskManagerQuickTask.userDashboard.loadedUserSuccess = function( element, response ) {
  element.closest( 'tr' ).replaceWith( response.data.template );
};
 ...
 * @version 6.2.5.0
 */
window.taskManagerQuickTask.userDashboard.savedUserSuccess = function( element, response ) {
...
window.taskManagerQuickTask.workunit = {};

window.taskManagerQuickTask.workunit.init = function() {
	window.taskManagerQuickTask.workunit.event();
};
 ...
 * @version 6.2.4.0
 */
window.taskManagerQuickTask.workunit.event = function() {
	jQuery( document ).on( 'keyup', '.digirisk-wrap .workunit-add input[type="text"]', window.taskManagerQuickTask.workunit.keyEnterSendForm );
	jQuery( document ).on( 'click', '.digirisk-wrap .workunit-list span[data-action="load_society"]', window.taskManagerQuickTask.workunit.setActive );
};
 ...
 * @version 6.2.4.0
 */
window.taskManagerQuickTask.workunit.keyEnterSendForm = function( event ) {
	if ( 13 === event.keyCode ) {
 ...
 * @version 6.2.4.0
 */
window.taskManagerQuickTask.workunit.saved_workunit_success = function( triggeredElement, response ) {
	jQuery( '.digirisk-wrap' ).replaceWith( response.data.template );
 ...
 * @version 6.2.4.0
 */
window.taskManagerQuickTask.workunit.setActive = function( event ) {
	jQuery( '.digirisk-wrap .workunit-list li.active' ).removeClass( 'active' );
	jQuery( this ).closest( 'li' ).addClass( 'active' );
};

window.taskManagerQuickTask.ZIP = {};

window.taskManagerQuickTask.ZIP.init = function() {
	window.taskManagerQuickTask.ZIP.event();
};

window.taskManagerQuickTask.ZIP.event = function() {
};
